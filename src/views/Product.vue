  ...
  <div id="product">
    ...
    <section class="specification">
      ...
      <div class="specification__bottom">
        <div class="options options--product">
          <details name="choose color" id="" class="options__color">
            <summary class="options__summary options__summary--product">
              choose color
            </summary>
          ...
          <details name="choose size" id="" class="options__size">
            <summary class="options__summary">choose size</summary>
            <fieldset class="options__wrapper">
              <label class="options__checkbox">
                <input checked type="checkbox" /><span class="options__item"
                  >xs</span
          ...
          <details name="quantity" id="" class="options__quantity">
            <summary class="options__summary">quantity</summary>
            <fieldset class="options__wrapper">
              <label class="options__checkbox">
      ...
      <button class="specification__button" @click.prevent="addProduct(mainProduct)">
        ...
        <p class="specification__info">Add to Cart</p>
      </button>
    </section>
    <!-- /. specification -->
...
.specification__button:hover .specification__img {
  fill: $colorLight;
}

.specification__button:hover .specification__info {
  color: $colorLight;
}
/************ Options ************/
.options {
